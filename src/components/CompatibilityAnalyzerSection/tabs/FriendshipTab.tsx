...
interface FriendshipTabProps extends CompatibilityTabProps {
...
const FriendshipTab: React.FC<FriendshipTabProps> = ({
  analysisResult,
  getScoreLevel,
}) => {
  return (
          ...
          {analysisResult.strengths.length > 0 && (
            <div className="strengths-section">
              <h3>
                ...
                Forces de cette relation d'amitié
              </h3>
              <ul>
      ...
      {analysisResult.recommendations.length > 0 && (
        <div className="recommendations">
          <h3>
            ...
            Recommandations pour votre amitié
          </h3>
          <ul>
